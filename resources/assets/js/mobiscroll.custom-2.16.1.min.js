...
if (!window.jQuery) {
    ...
    (function (a) {
        ["width", "height"].forEach(function (m) {
            a.fn[m] = function (c) {
                var l, e = document.body, w = document.documentElement, s = m.replace(/./, function (a) {
        ...
        ["Left", "Top"].forEach(function (m, c) {
            ...
            a.fn[e] = function (m) {
                ...
                this.each(function () {
                    if (v = l(this)) {
                        var s = !c ? m : a(v).scrollLeft(), I = c ? m : a(v).scrollTop();
                        v.scrollTo(s, I)
                    } else this[e] = m
                })
            }
...
;(function (a, m) {
    function c(a) {
        for (var c in a)if (I[a[c]] !== m)return !0;
        return !1
    }
    ...
    var w, s = +new Date, v =
            {}, L = a.extend, I = document.createElement("modernizr").style,
        i = c(["perspectiveProperty", "WebkitPerspective", "MozPerspective", "OPerspective", "msPerspective"]),
        f = c(["flex", "msFlex", "WebkitBoxDirection"]), ka = function () {
            var a = ["Webkit", "Moz", "O", "ms"], f;
            for (f in a)if (c([a[f] + "Transform"]))return "-" + a[f].toLowerCase() + "-";
            return ""
    ...
    w = a.mobiscroll = a.mobiscroll ||
        {
            version: "2.16.1",
            util: {
                prefix: ka, jsPrefix: qa, has3d: i, hasFlex: f, testTouch: function (c, f) {
                    ...
                    var c = {}, f;
                    if (a)for (f = 0; f < a.length; f++)c[a[f]] = a[f];
                    return c
                    ...
                    var e =
                        a.originalEvent || a, c = (f ? "client" : "page") + c;
                    return e.changedTouches ? e.changedTouches[0][c] : a[c]
                }, getPosition: function (c, f) {
                    var e = window.getComputedStyle ? getComputedStyle(c[0]) : c[0].style, l, v;
...
(function (a, m, c, l) {
    var e, w, s = a.mobiscroll, v = s.util, L = v.jsPrefix, I = v.has3d, i = v.getCoord, f = v.constrain,
        ka = v.isString, qa = /android [1-3]/i.test(navigator.userAgent),
        v = /(iphone|ipod|ipad).* os 8_/i.test(navigator.userAgent), ba = function () {
        }, ha = function (a) {
            a.preventDefault()
        };
    s.classes.Frame = function (v, da, ca) {
        ...
        var T, G, ra, z, fa, Y, E, r, W, g, P, F, J, q, D, K, p, B, H, o, b, n, V, Z, d = this, O = a(v), U = [],
            N = {};
        s.classes.Base.call(this, v, da, !0);
        d.position = function (g) {
            var e, i, k, n, m, u, C, v, h, $, wa = 0, Da = 0;
            h = {};
            var q = Math.min(r[0].innerWidth || r.innerWidth(), Y.width()), Q = r[0].innerHeight || r.innerHeight();
            ...
            if (!o.disabled && !d._isVisible) {
                ...
                z.on("selectstart mousedown", ha).on("click", ".dwb-e", ha).on("keydown", ".dwb-e", function (b) {
                    ...
                    if (b.keyCode == 32) b.preventDefault(); else if (b.keyCode == 9 && D) {
                        ...
                        }), c = d.index(a(":focus", z)), f = d.length - 1, g = 0;
                        if (b.shiftKey) {
                            f = 0;
                            g = -1
                        }
...
(function (a) {
    var a = a.mobiscroll.themes.frame, m = {
        dateOrder: "Mddyy",
        rows: 5,
        minWidth: 76,
        height: 36,
...
(function (a, m, c, l) {
    var e, m = a.mobiscroll, w = m.classes, s = m.util, v = s.jsPrefix, L = s.has3d, I = s.hasFlex, i = s.getCoord,
        f = s.constrain, ka = s.testTouch;
    ...
    w.Scroller = function (m, ba, ha) {
        ...
        function ca(h) {
            if (e) {
                var $ = new Date - V, g = f(Math.round(d + (n - Z) / D), O - 1, U + 1), u = g, i, l = N.offset().top;
                h.stopPropagation();
                e = !1;
                ...
                if (b) u = f(Math.round(d - $ / D), O, U), $ = i ? Math.max(0.1, Math.abs((u - g) / i) *
                    p.timeUnit) : 0.1; else {
                    var g = Math.floor((Z - l) / D), C = a(a(".dw-li", N)[g]);
                    i = C.hasClass("dw-v");
                    l = q;
                    $ = 0.1;
        ...
        function y(h) {
            if (!S(this) && a.mobiscroll.running) {
                h.preventDefault();
                var h = h.originalEvent || h, b = h.deltaY || h.wheelDelta || h.detail, d = a(".dw-ul", this);
                G(d);
        ...
        function T(h) {
            var b = '<div class="dw-bf">', h = ma[h], d = 1, c = h.labels || [], g = h.values || [], f = h.keys || g;
        ...
        function Y(b, d, c, g, e) {
            var u = a('.dw-li[data-val="' +
                b + '"]', d), i = a(".dw-li", d), b = i.index(u), k = i.length;
            ...
            return {
                selected: c, v: g ? f(b, O, U) : b, val: u.hasClass("dw-v") || g ? u.attr("data-val") :
                    null
            }
        }
        ...
        function E(b, d, c, g, f) {
            !1 !== H("validate", [F, d, b, g]) && (a(".dw-ul", F).each(function (c) {
                var u = a(this), e = u.closest(".dwwl").hasClass("dwwms"), i = c == d || d === l,
        ...
        var F, J, q, D, K, p, B, H, o, b, n, V, Z, d, O, U, N, M, na, ia, k = this, oa = a(m), la = {}, u = {}, C = {},
            ma = [];
...
(function (a) {
    ...
    m.datetime = {
        defaults: {
            ...
            if (!l)return null;
            var e = a.extend({}, m.datetime.defaults, e), w = function (a) {
                for (var f =
                    0; L + 1 < c.length && c.charAt(L + 1) == a;)f++, L++;
                return f
            }, s = function (a, c, f) {
                c = "" + c;
                if (w(a))for (; c.length < f;)c = "0" + c;
                return c
            }, v = function (a, c, f, e) {
                return w(a) ? e[c] : f[c]
            }, L, I, i = "", f = !1;
            for (L = 0; L < c.length; L++)if (f) "'" == c.charAt(L) && !w("'") ? f = !1 : i += c.charAt(L); else switch (c.charAt(L)) {
                case "d":
                    i += s("d", e.getDay(l), 2);
                    break;
                case "D":
            ...
            var e = a.extend({}, m.datetime.defaults, e), w = e.defaultValue || new Date;
            if (!c || !l)return w;
            if (l.getTime)return l;
            var l = "object" == typeof l ? l.toString() : l + "", s = e.shortYearCutoff, v = e.getYear(w),
                L = e.getMonth(w) + 1, I = e.getDay(w), i = -1, f = w.getHours(), ka = w.getMinutes(), qa = 0, ba = -1,
                ha = !1, ja = function (a) {
                    ...
                    a = ja(a) ? f : c;
                    for (c = 0; c < a.length; c++)if (l.substr(ea, a[c].length).toLowerCase() == a[c].toLowerCase())return ea += a[c].length, c + 1;
                    return 0
                }, ea = 0, x;
            for (x = 0; x < c.length; x++)if (ha) "'" == c.charAt(x) && !ja("'") ? ha = !1 : ea++; else switch (c.charAt(x)) {
                case "d":
                    I = da("d");
                    break;
                case "D":
...
(function (a, m, c, l) {
    var e = a.mobiscroll, w = e.presets.scroller, s = e.util, v = s.has3d, L = s.jsPrefix, I = s.testTouch, i = {
        controls: ["calendar"],
        firstDay: 0,
        weekDays: "short",
        maxMonthWidth: 170,
    ...
    w.calbase = function (f) {
        function m(b, c, d) {
            var g, f, h, e, u = {}, i = ga + Oa;
            b && a.each(b, function (a, b) {
                g = b.d || b.start || b;
                f = g + "";
                if (b.start && b.end)for (e = new Date(b.start); e <= b.end;)h = new Date(e.getFullYear(), e.getMonth(), e.getDate()), u[h] = u[h] || [], u[h].push(b), e.setDate(e.getDate() + 1); else if (g.getTime) h = new Date(g.getFullYear(), g.getMonth(), g.getDate()), u[h] = u[h] || [], u[h].push(b); else if (f.match(/w/i)) {
        ...
        function ha(b, c) {
            var d, g, h, u, e, i, k, n, C, $, m, r, v, q, p = 1, o = 0;
            d = j.getDate(b, c, 1);
            var V = j.getYear(d), s = j.getMonth(d),
                ma = null === j.defaultValue && !f._hasValue ? null : f.getDate(!0), Z = j.getDate(V,
                s, 1).getDay(), t = '<div class="dw-cal-table">', A = '<div class="dw-week-nr-c">';
        ...
        function ja(b, d, c) {
            var f = j.getDate(b, d, 1), e = j.getYear(f), f = j.getMonth(f), i = e + Wa;
            if (Ga) {
                ...
                if (e === la)for (g = 0; g < C; g++)a('.dw-cal-month-s[data-val="' + g + '"]', q).addClass("dwb-d");
                if (e === u)for (g = ma + 1; 12 >= g; g++)a('.dw-cal-month-s[data-val="' + g + '"]', q).addClass("dwb-d")
            }
        ...
        function y(d, c, h, e, u, i, k) {
            ...
            if (!La) {
                var n = Ra.shift(), d = n.y, c = n.m, h = "next" === n.dir, e = n.slideNr, u = n.load, i = n.active,
                    k = n.callback || Xa, n = j.getDate(d, c, 1), d = j.getYear(n), c = j.getMonth(n);
                La = !0;
                f.changing = !0;
                f.trigger("onMonthChange",
                    [d, c]);
                qa(d, c);
                if (u)for (g = 0; g < A; g++)sa[h ? xa - A + g : g].html(ha(d, c - pa + g));
                        ...
                        setTimeout(function () {
                            ...
                            if (sa.length) {
                                ...
                                if (h) {
                                    ...
                                    j = sa.splice(xa - e, e);
                                    for (g = e - 1; 0 <= g; g--)sa.unshift(j[g]), S(sa[0],
        ...
        function t() {
            var b = a(this), d = f.live, c = f.getDate(!0), g = b.attr("data-full"),
                h = g.split("-"), h = new Date(h[0], h[1], h[2]),
        ...
        var W, g, P, F, J, q, D, K, p, B, H, o, b, n, V, Z, d, O, U, N, M, na, ia, k, oa, la, u, C, ma, h, $, wa, Da,
            Ea, Q, aa, Ua, Va, bb, cb, Ja, Aa, La, va, A, xa, Oa, pa, Pa, za, Ia, Qa, fb = this, Sa = [], sa = [],
            Ra = [], ta = {}, db = {}, Xa = function () {
            }, jb = a.extend({}, f.settings), j = a.extend(f.settings, i, jb),
            kb = "full" == j.weekDays ? "" : "min" == j.weekDays ? "Min" : "Short", Na = j.weekCounter,
            gb = j.layout || (/top|bottom/.test(j.display) ? "liquid" : ""), Ca = "liquid" == gb &&
                "bubble" !== j.display, hb = "modal" == j.display, Fa = j.rtl, Ma = Fa ? -1 : 1,
            ib = Ca ? null : j.calendarWidth, ya = "vertical" == j.swipeDirection, Ga = j.quickNav, ga = j.preMonths,
            Ka = "yearMonth" == j.navigation, Ya = j.controls.join(","),
            Ta = (!0 === j.tabs || !1 !== j.tabs && Ca) && 1 < j.controls.length,
            Za = !Ta && j.tabs === l && !Ca && 1 < j.controls.length, Wa = j.yearSuffix || "", Ha = j.activeClass || "",
            $a = "dw-sel " + (j.activeTabClass || ""), ab = j.activeTabInnerClass || "",
            eb = "dwb-d " + (j.disabledClass || ""), Ba = "", ua = "";
        ...
        a.extend(F, {
            ariaMessage: j.calendarText, onMarkupReady: function (i) {
                var m, o, w = "";
                q = i;
                ...
                var a, b, d;
                b = f.getDate(true);
                if (o) a = "calendar"; else for (d in f.order)d && f.order[d] === g && (a = /mdy/.test(d) ? "date" : "time");
...
(function (a, m) {
    var c = a.mobiscroll, l = c.classes, e = c.util, w = e.constrain, s = e.jsPrefix, v = e.prefix, L = e.has3d,
        I = e.getCoord, i = e.getPosition, f = e.testTouch, ka = e.isNumeric, qa = e.isString,
        ba = "webkitTransitionEnd transitionend", ha = window.requestAnimationFrame || function (a) {
                a()
    ...
    l.ScrollView = function (c, e, ea) {
        ...
        function S(a) {
            ...
            if (V) {
                ...
                } else if (0 <= a)for (a = 0; a < V.length; a++)if (Math.abs(b) <=
                    V[a].breakpoint) {
                    la = a;
                    u = 1;
                    b = V[a].snap1;
        ...
        function T(a, b, d) {
            ...
            B = !0;
            if (L)if (N[s + "Transition"] = b ? v + "transform " + Math.round(b) + "ms " + C.easing : "", N[s + "Transform"] = "translate3d(" + (ia ? "0," + a + "px," : a + "px,0,") + "0)", oa == a || !b) c(); else {
        ...
        var G,
            ra, z, fa, Y, E, r, W, g, P, F, J, q, D, K, p, B, H, o, b, n, V, Z, d, O, U, N, M, na, ia, k = this, oa = 0,
            la = 0, u = 1, C = e, ma = a(c);
        ...
        k.refresh = function () {
            ...
            (V = [], M.find(C.snap).each(function () {
                var a = ia ? this.offsetTop : this.offsetLeft, b = ia ? this.offsetHeight : this.offsetWidth;
...
(function (a, m) {
    var c = a.mobiscroll, l = c.datetime, e = new Date, w = {
        ...
        function f(a) {
            if (null === a)return a;
            var b = s(a, "y"), d = s(a, "m"), c = Math.min(s(a, "d", 1), r.getMaxDayOfMonth(b, d)), e = s(a, "h", 0);
            return r.getDate(b, d, c, s(a, "a", 0) ? e + 12 : e, s(a, "i", 0), s(a, "s", 0), s(a, "u", 0))
        }

        function ka(a, b) {
            var d, c, e = !1, g = !1, i = 0, n = 0;
            U = f(ca(U));
            N = f(ca(N));
            if (qa(a))return a;
            a < U && (a = U);
            a > N && (a = N);
            c = d = a;
            if (2 !== b)for (e = qa(d); !e && d < N;)d = new Date(d.getTime() + 864E5), e = qa(d), i++;
            if (1 !== b)for (g = qa(c); !g && c > U;)c = new Date(c.getTime() - 864E5), g = qa(c), n++;
            return 1 ===
        ...
        function ba(a, b) {
            var d, c, e;
            if (b)for (c = 0; c < b.length; c++)if (d = b[c], e = d + "", !d.start)if (d.getTime) {
        ...
        function ha(a, b, d, c, e, g,
                    f) {
            var i, n, k;
            if (a)for (i = 0; i < a.length; i++)if (n = a[i], k = n + "", !n.start)if (n.getTime) r.getYear(n) == b && r.getMonth(n) == d && (g[r.getDay(n) - 1] = f); else if (k.match(/w/i)) {
                k = +k.replace("w", "");
        ...
        function ja(c, e, f, h, n, k, l, q, o) {
            var p, s, V, v, t, w, x, y, z, A, B, D, M, G, F, I, L, N, U = {}, H = {h: Z, i: d, s: O, a: 1},
                K = r.getDate(n, k, l), J = ["a", "h", "i", "s"];
            c && (a.each(c, function (a, b) {
                ...
                if (c.start && (c.apply || !c.d && !U[K])) {
                    ...
                    if (!o)for (A = e + 1; 4 > A; A++)0 < v[A] && (M = H[f]), t[A] < E[J[A]] && (G = H[f]);
        ...
        var t, S, T, G, ra, z, fa, Y, E, y = a.extend({}, e.settings),
            ...
            }, D = r.invalid, K = r.valid, y = r.preset, p = r.dateOrder, B = r.timeWheels, H = p.match(/D/),
            o = B.match(/a/i), b = B.match(/h/), n = "datetime" == y ? r.dateFormat + r.separator +
                r.timeFormat : "time" == y ? r.timeFormat : r.dateFormat, V = new Date, x = r.steps || {},
            Z = x.hour || r.stepHour || 1, d = x.minute || r.stepMinute || 1, O = x.second || r.stepSecond || 1,
            x = x.zeroBased, U = r.minDate || new Date(r.startYear, 0, 1),
            N = r.maxDate || new Date(r.endYear, 11, 31, 23, 59, 59), M = x ? 0 : U.getHours() % Z,
            na = x ? 0 : U.getMinutes() % d, ia = x ? 0 : U.getSeconds() % O,
            k = Math.floor(((b ? 11 : 23) - M) / Z) * Z + M, oa = Math.floor((59 - na) / d) * d + na,
        ...
        return {
            wheels: R, headerText: r.headerText ? function () {
                ...
                var d = ka(f(e.getArrayVal(!0)), i), n = ca(d), k = s(n, "y"), l = s(n, "m"), o = !0, t = !0;
                a.each("y,m,d,a,h,i,s".split(","), function (d, c) {
                    if (F[c] !== m) {
                        var e = Y[c], f = E[c], g = 31, i = s(n, c), h = a(".dw-ul", b).eq(F[c]);
                        if (c == "d") {
                            f = g = r.getMaxDayOfMonth(k, l);
                            H && a(".dw-li", h).each(function () {
                                var b = a(this), d = b.data("val"), c = r.getDate(k, l, d).getDay(),
                ...
                fa && a.each(["a", "h", "i", "s"], function (d, c) {
                    var f = s(n, c), q = s(n, "d"), o = a(".dw-ul", b).eq(F[c]);
...
(function (a, m, c, l) {
    var e = a.mobiscroll, w = a.extend, s = e.util, v = e.datetime, L = e.presets.scroller, I = {
    ...
    L.calendar = function (c) {
        ...
        function qa(b) {
            ...
            var e = b.outerHeight(), f = b.outerWidth(), d = b.offset().top - a(".dw-cal-c", x).offset().top,
        ...
        function ba(b, n) {
            ...
            if (l) {
                ...
                a.each(l, function (a, b) {
                    ...
                    if (b.start && b.end) {
                        n = g.labelsShort;
                        var l = Math.abs(b.end - b.start) / 1E3, s = l / 60, t = s / 60, h = t / 24, v = h / 365;
        ...
        function da(a) {
            B = {};
            if (a && a.length)for (z = 0; z < a.length; z++)B[ja(a[z])] =
                a[z]
        }
        ...
        E = w({}, c.settings);
        var g = w(c.settings, I, E), P = "dw-sel dw-cal-day-ev", F = "dw-cal-day-hl", J = g.activeClass || "",
            q = g.multiSelect || "week" == g.selectType, D = g.markedDisplay,
            K = !0 === g.events || !0 === g.markedText, p = 0, B = {}, H = a.isArray(g.events),
            o = H ? w(!0, [], g.events) : [];
        E = L.calbase.call(this, c);
        ea = w({}, E);
        ra = g.firstSelectDay === l ? g.firstDay : g.firstSelectDay;
        if (g.selectedValues)for (z = 0; z < g.selectedValues.length; z++)B[ja(g.selectedValues[z])] =
            g.selectedValues[z];
        ...
        w(E, {
            ...
            onBeforeShow: function () {
                ...
                if (g.counter && q) g.headerText = function () {
                    var b = 0, c = g.selectType == "week" ? 7 : 1;
                    a.each(B, function () {
                        b++
                    });
                    b = Math.round(b / c);
            ...
            onDayChange: function (b) {
                var e = b.date, f = ja(e), l = a(b.cell), b = b.selected;
                if (H) {
                    ha();
                    ...
                    var d, m, o = f.getDay() - ra, o = o < 0 ? 7 + o : o;
                    g.multiSelect || (B = {});
                    for (d = 0; d < 7; d++) {
...
(function (a) {
    var m, c, l, e = a.mobiscroll, w = e.themes;
