					...
					<div class="box-body">
						...
						@else
							<div class="form-group">
								<label class="col-md-4 control-label">@lang('admin.category'):
						...
						<div class="form-group">
							<label class="col-md-4 control-label">@lang('admin.thumb'):
								<span class="required">*</span>
							</label>
							<div class="col-md-6">
						...
						<div class="form-group">
							<label class="col-md-4 control-label">@lang('admin.letter'):
								<span class="required">*</span>
							</label>
							<div class="col-md-8">
						...
						<div class="form-group">
							<label class="col-md-4 control-label">来源:
								<span class="required">*</span>
							</label>
							<div class="col-md-8">
								<input type="text" class="form-control" name="info[copyfrom]"
								       value="{{ $news->copyfrom or '本站' }}">
							</div>
						</div>
						<div class="form-group url" style="display: none;">
							<label class="col-md-4 control-label">@lang('admin.url'):
								<span class="required">*</span>
							</label>
							<div class="col-md-8">
						...
						<div class="form-group">
							<label class="col-md-4 control-label">@lang('admin.islink'):
								<span class="required">*</span>
							</label>
							<div class="col-md-8">
								<select name="info[islink]" class="form-control is_link">
									<option @if(isset($news->islink) && $news->islink == 0)selected @endif value="0">@lang('admin.no')</option>
									<option @if(isset($news->islink) && $news->islink == 1)selected @endif value="1">@lang('admin.yes')</option>
								</select>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-4 control-label">是否允许评论:
								<span class="required">*</span>
							</label>
							<div class="col-md-8">
								<select name="info[allow_comment]" class="form-control">
									<option @if(isset($news->allow_comment) && $news->allow_comment == 1)selected @endif value="1">@lang('admin.yes')</option>
									<option @if(isset($news->allow_comment) && $news->allow_comment == 0)selected @endif value="0">@lang('admin.no')</option>
								</select>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-4 control-label">@lang('admin.sort'):
								<span class="required">*</span>
							</label>
							<div class="col-md-8">
						...
						<div class="form-group">
							<label class="col-md-4 control-label">@lang('admin.read'):
								<span class="required">*</span>
							</label>
							<div class="col-md-8">
						...
						<div class="form-group">
							<label class="col-md-4 control-label">@lang('admin.like'):
								<span class="required">*</span>
							</label>
							<div class="col-md-8">
